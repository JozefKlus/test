...
> Otvoriť túto stránku na [https://jozefklus.github.io/test/](https://jozefklus.github.io/test/)
...
* vyhľadať **https://github.com/jozefklus/test** a importovať

## Upraviť tento projekt ![Odznak stavu zostavy](https://github.com/jozefklus/test/workflows/MakeCode/badge.svg)

Ak chcete upraviť tento odkladací priestor v aplikácii MakeCode.

* otvoriť [https://makecode.microbit.org/](https://makecode.microbit.org/)
* kliknite na **Importovať** a potom na **Importovať adresu URL**
* prilepte **https://github.com/jozefklus/test** a kliknite na tlačidlo importu
...
![Vykreslené zobrazenie blokov](https://github.com/jozefklus/test/raw/master/.github/makecode/blocks.png)
